...
namespace Shopping.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserHelper userHelper, DataContext context, ICombosHelper combosHelper, IMailHelper mailHelper, IFlashMessage flashMessage/*, IBlobHelper blobHelper*/)
        {
        ...
        {
            if (User.Identity.IsAuthenticated)// el objeto me va a devolver el usuario loggeado
            {
        ...
        public async Task<IActionResult> Register()
        {
            ...
            {
                Id = Guid.Empty.ToString(),//pase un guid vacio
        ...
        public JsonResult GetStates(int countryId)//va a devolver los estados en formato json
        {
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    _flashMessage.Danger(string.Empty, "User no found.");
                }
            }
